...
\newcommand*{\corr}[2]{\operatorname{Corr}\qty(#1,#2)}
...
\newcommand*{\bs}[3]{\operatorname{BS}\qty(#1;#2;#3)}
\newcommand*{\ndist}[2]{\operatorname{N}\qty(#1,#2)}
\newcommand*{\lndist}[2]{\operatorname{LN}\qty(#1,#2)}
\newcommand*{\iid}{\overset{\mathrm{iid}}{\sim}}
\newcommand*{\rnsim}{\overset{\mathrm{RN}}{\sim}}
